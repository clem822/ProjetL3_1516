...
public enum Caracteristique {
	...
	/**
	 * Invisibilit� : D�finit l'invisibilit�. Lorsque la valeur est � 0 alors le personnage est visible.
	 */
	...
	public static HashMap<Caracteristique,Integer> mapCaracteristiquesDefaut() {
		...
		//Va initialiser chaque carac�ristique par la valeur initaliale.
