 ...
 *
 */
public class Invisibilite extends Interaction<VuePotion> {
	 ...
	 */
	public Invisibilite(Arene arene, VuePersonnage ramasseur, VuePotion potion) {
	...
	public void interagit() {
		try {
			...
			if(attaquant.getElement().estVivant()) {
				...
				logs(Level.INFO, "Je suis invicible maintenant !");
